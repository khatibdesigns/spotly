  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ position: 'absolute', left: 0, right: 0, bottom: 0, top: insets.top + 40, backgroundColor: C.bg, borderTopLeftRadius: 28, borderTopRightRadius: 28 }}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 22, paddingBottom: insets.bottom + 60 }} keyboardShouldPersistTaps="handled" automaticallyAdjustKeyboardInsets keyboardDismissMode="interactive">
